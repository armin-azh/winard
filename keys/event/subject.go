...
const (
	EventSubjectAdminCreate            = "admin-created"
	EventSubjectAdminUpdate            = "admin-updated"
	EventSubjectAgentCreate            = "agent-created"
	EventSubjectAgentUpdate            = "agent-updated"
	EventSubjectThirdPartyCreate       = "third-party-created"
	...
	EventSubjectTransactionUpdated     = "transaction-updated"
)
